...
def resolve_container_template(
  ...
  if isinstance(container_spec_tmpl, executor_spec.ContainerSpec):
...
def resolve_container_command_line(
    container_spec: executor_spec.ContainerSpec,
    input_dict: Dict[Text, List[types.Artifact]],
    output_dict: Dict[Text, List[types.Artifact]],
  ...
  def expand_command_line_arg(
      cmd_arg: executor_spec.CommandlineArgumentType,
  ) -> Text:
